...
celestia ${NODE_TYPE} start --rpc.port ${NODE_RPC_PORT} --core.ip ${CORE_IP} --core.grpc.port ${CORE_GRPC_PORT} --metrics.tls=false --metrics --metrics.endpoint ${METRICS_ENDPOINT}
